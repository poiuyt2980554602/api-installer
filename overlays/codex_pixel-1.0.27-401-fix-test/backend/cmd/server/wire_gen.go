...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subsiteForwarder := handler.NewSubsiteForwarder(subsiteService, settingService, accountRepository)
	...
	requestAuthorizeService := service.NewRequestAuthorizeService(subsiteRepository, accountLeaseRepository, quotaReservationRepository, apiKeyService, subscriptionService, accountRepository, billingService, modelPricingResolver, proxyRepository)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, userAccountHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, conversationHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, subsiteForwarder, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, subsiteInternalHandler, receiptCodeHandler, handlerWithdrawalHandler, shopHandler, idempotencyCoordinator, idempotencyCleanupService)
