...
func RegisterAdminRoutes(
	...
	admin.Use(gin.HandlerFunc(adminAuth))
	{
		...
		registerProxyAffinityRoutes(admin, h)
...
func registerProxyAffinityRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	affinity := admin.Group("/proxy-affinity")
	{
		affinity.GET("/settings", h.Admin.ProxyAffinity.GetSettings)
		...
		affinity.POST("/prebind", h.Admin.ProxyAffinity.Prebind)
